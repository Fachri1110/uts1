              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <a href="{{ url('/home') }}">
                      <button type="button" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Sign in</button></a>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="{{ url('/signup') }}" target="_blank" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
